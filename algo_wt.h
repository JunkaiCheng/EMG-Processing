#ifndef _MAVOR_EMG_WT_ALGO_H_
#define _MAVOR_EMG_WT_ALGO_H_
#include "algorithm.h"
#include "data_wt.h"
#include "param_wt.h"
#include "dwt.h"
...
class CAlgoWT : public CAlgo
{
public:
	CAlgoWT();
	~CAlgoWT();
	CAlgoWT(const CAlgoWT& rhs);
	CAlgoWT(const std::string& class_name);
	CAlgoWT& operator = (const CAlgoWT& rhs);
public:
...
private:
	...
	std::shared_ptr<CDataWT>			m_output;
